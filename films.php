        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form enctype="multipart/form-data" method="post" action="addfilms.php">
                    ...
                    <div class="field">
                        <input id="actors" class="form-control" placeholder="Перелік акторів" name="actors" type="text" title= "Перелік акторів писати через кому! В іншому випадку система рахуватиме написане як одну людину." pattern="^(\w+[, ]+)*\w+$" required>
                    </div>
